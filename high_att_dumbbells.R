...
race %>% 
  ...
  geom_dumbbell(size_x = 3, size_xend = 3, size = 1, color="azure3", 
                colour_x = "darkorchid", colour_xend = "firebrick3",
                dot_guide=FALSE, dot_guide_size=0.05)  + mean_rb() +
  theme(plot.title = element_text(size=24)) +
  scale_x_continuous(labels = scales::percent) +
  geom_text(data=filter(race, group == "Entire Sample"), aes(x=all_pct, y=group, label="All Levels"), color="black", size=4, vjust=-1, fontface="bold", family="Product Sans") +
  geom_text(data=filter(race, group == "Entire Sample"), aes(x=high_pct, y=group, label="Weekly+ Attenders"), color="black", size=4, vjust=-1, fontface="bold", family="Product Sans") +
  labs(x = "Percent of Two Party Vote for Trump", y = "Racial Group", subtitle = "", caption = "Data: CCES 2016", title = "The Impact of Frequent Attendance on Vote Choice")
...
denom %>% 
  ...
  geom_text(data=filter(denom, group == "Catholics"), aes(x=all_pct, y=group, label="All Levels"), color="black", size=4, vjust=-1, fontface="bold", family="Product Sans") +
  geom_text(data=filter(denom, group == "Catholics"), aes(x=high_pct, y=group, label="Weekly+ Attenders"), color="black", size=4, vjust=-1, fontface="bold", family="Product Sans") +
  labs(x = "Percent of Two Party Vote for Trump", y = "Religious Group", subtitle = "", caption = "Data: CCES 2016", title = "The Impact of Frequent Attendance on Vote Choice")

ggsave(file="D://cces/high_att_dumbbell_denoms.png", type = "cairo-png", width = 12, height = 6)
...
ed %>% 
  ...
  geom_text(data=filter(ed, group == "High School or Less"), aes(x=all_pct, y=group, label="All Levels"), color="black", size=4, vjust=-1, fontface="bold", family="Product Sans") +
  geom_text(data=filter(ed, group == "High School or Less"), aes(x=high_pct, y=group, label="Weekly+ Attenders"), color="black", size=4, vjust=-1, fontface="bold", family="Product Sans") +
  labs(x = "Percent of Two Party Vote for Trump", y = "Religious Group", subtitle = "", caption = "Data: CCES 2016", title = "The Impact of Frequent Attendance on Vote Choice")

ggsave(file="D://cces/high_att_dumbbell_educ.png", type = "cairo-png", width = 12, height = 6)
